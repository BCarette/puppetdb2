...
Puppet::Type.type(:db2_catalog_node).provide(:db2, :parent => Puppet::Provider::Db2) do
  ...
  def get_nodes
    ...
    #
    output_nodes = db2_exec_instance_user_nofail('list node directory show detail')
    output_admin_nodes = db2_exec_instance_user_nofail('list admin node directory show detail')
